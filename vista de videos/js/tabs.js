...
var propTabs = {
	...
	primer_encabezado: document.getElementById('encabezado-videos').firstElementChild,
	primer_contenido: document.getElementById('video-container').firstElementChild,
	enlaces_encabezado: document.querySelectorAll('#encabezado-videos li a'),
	li_encabezado: document.querySelectorAll('#encabezado-videos li'),
	divs_contenido: document.querySelectorAll('#video-container > div'),
...
var metTabs = {
	...
	evento: function (e) {
		...
		this.parentElement.firstElementChild.style.color = 'rgba(75, 5, 5, 0.719)';
